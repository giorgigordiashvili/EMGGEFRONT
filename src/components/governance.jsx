      ...
      <div>
        ...
        <div className="tab-content" id="nav-tabContent">
          ...
          <div className="container p-4">
            {/* {" "}
            <h5 className="color-emg col-12 col-md-12 pl-04">მენეჯმენტი</h5> */}
          </div>
          <div className="fluid-container highlight">
            <div className="container highlight p-5">
              <div className="row">
                <Manager
                  ...
                  experience="საბანკო სექტორში წამყვან პოზიციებზე 17- წლიანი სტაჟი"
                  work="5 წელზე მეტია მუშაობს ტექნოლოგიების, პროექტების მართვის, ინვესტირებისა და საკონსულტაციო მომსახურების, ბოლო 3 წელი კი - ინსპექტირების, ექსპერტიზისა და ზედამხედველობის მიმართულებით."
                ></Manager>
                <Manager
                  name="გია ჩანტლაძე"
                  position="დირექტორი"
                  id="manager2"
                  profession="ინჟინერი"
                  education="საქართველოს პოლიტექნიკური ინსტიტუტი - მაგისტრი, საავტომობილო გზების ინჟინერია;"
                  experience="სახელმწიფო თუ კერძო სტრუქტურებში წამყვან პოზიციებზე მუშაობის 40-წლიანი სტაჟი;"
                  work="მისი უშუალო ზედამხედველობით განხორციელდა გზების, ხიდებისა და გვირაბების მშენებლობა-რეაბილიტაციისა და მოვლა-შენახვის 20-მდე მასშტაბური პროექტი საქართველოში."
                ></Manager>
                <Manager
                  ...
                  id="manager3"
                  profession="ინჟინერი"
                  education="საქართველოს ტექნიკური უნივერსიტეტი-მაგისტრი,ინჟინერია; საქართველოს ტექნიკური უნივერსიტეტის მშენებლობის ფაკულტეტი - დოქტორანტი;"
                  experience="სამშენებლო სფეროში მუშაობის 10-წლიანი სტაჟი როგორც საქართველოში, ისე მის საზღვრებს გარეთ;"
                  work="მისი პორტფოლიო მოიცავს საქართველოში,
                  საფრანგეთსა და იტალიაში აშენებულ მრავალფუნქციურ სასტუმროებსა და
                  საცხოვრებელ კორპუსებს (მთავარი კონსტრუქტორი), სხვადასხვა ფუნქციური
                  დანიშნულების შენობა-ნაგებობებს (ინსპექტორი)."
                ></Manager>
                <Manager
                  ...
                  education="საქართველოს პოლიტექნიკური ინსტიტუტის სამშენებლო
                  ფაკულტეტი, სამრეწველო და სამოქალაქო მშენებლობა;"
                  experience="სამშენებლო სფეროში მუშაობის 50-წლიანი სტაჟი
                  როგორც სახელმწიფო, ისე კერძო ორგანიზაციებში;"
                  work="აქვს განსხვავებული ფუნქციური დანიშნულების
                  ობიექტებზე მუშაობის მრავალწლიანი გამოცდილება. მის, როგორც მთავარი
                  სპეციალისტის, პროფესიულ ანგარიშზე ათობით პროექტი ირიცხება დედაქალაქსა
                  და რეგიონებში."
                ></Manager>
                <Manager
                  ...
                  education="ტვენტეს ტექნოლოგიური უნივერსიტეტი (ჰოლანდია) – მაგისტრი,
                  მშენებლობის მართვა;
                  შვედეთის სამეფო ტექნოლოგიური უნივერსიტეტი (შვედეთი) –
                  კურსდამთავრებული, მიწის მართვის სამაგისტრო პროგრამა;
                  საქართველოს ტექნიკური უნივერსიტეტის არქიტექტურისა და ურბანული
                  დაგეგმარების ფაკულტეტი;"
                  experience="არქიტექტურის სფეროში მუშაობის 20-წლიანი სტაჟი;"
                  work="შესრულებული აქვს 15-მდე მასშტაბური
                  პროექტი თბილისსა და რეგიონებში, მათ შორის, სასტუმრო კომპლექსები,
                  მულტიფუნქციური შენობები, საცხოვრებელი კორპუსები, ისტორიული
                  ნაგებობების რეკონსტრუქცია და სხვა."
                ></Manager>
              </div>
              {/* /.row */}
            </div>
